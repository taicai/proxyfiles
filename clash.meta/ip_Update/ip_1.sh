...
start_copy() {
    ...
    \cp -p list.meta.yml ../../config_1.yaml 
    mv -f "list.meta.yml" "../config.yaml"
}

# 尝试从第一个URL下载配置
download_config "https://ghproxy.net/https://raw.githubusercontent.com/peasoft/NoMoreWalls/master/list.meta.yml"

# 尝试从第二个URL下载配置
download_config "https://raw.githubusercontent.com/peasoft/NoMoreWalls/master/list.meta.yml"
