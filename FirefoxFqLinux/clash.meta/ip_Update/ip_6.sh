...
start_copy() {
    ...
    \cp -p list.meta.yml ../../config_6.yaml 
    mv -f "list.meta.yml" "../config.yaml"
}

# 尝试从第一个URL下载配置
download_config "https://cdn.jsdelivr.net/gh/chengaopan/AutoMergePublicNodes@master/list.meta.yml"

# 尝试从第二个URL下载配置
download_config "https://fastly.jsdelivr.net/gh/chengaopan/AutoMergePublicNodes@master/list.meta.yml"
